  ...
  return (
    <div className="pt-24 px-6 md:px-12">
      <div className="max-w-[700px] mx-auto">
        ...
        <div className={`font-mono text-sm uppercase mb-8 ${STATE_COLOR[a.state]}`}>{a.state}</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 border border-white/10 p-6 mb-8">
          ...
          <div>
            ...
            <div className={`font-mono text-2xl ${a.d24h > 0 ? 'text-red-400' : 'text-zinc-600'}`}>
              +{a.d24h}
            </div>
          </div>
        </div>
        ...
        <div className="border border-white/10 p-6 mb-8">
          ...
          <div className="grid grid-cols-4 gap-3">
            {(['MID', 'M2M_SE', 'LCH', 'CSD'] as const).map((key) => (
